...
#pragma warning disable 1591
		...
		private static readonly Queue<CustomEventToFireInfo> CustomEventsToFire = new Queue<CustomEventToFireInfo>(32);
        ...
        private static void FireCustomEventsWaiting() {
            while (CustomEventsToFire.Count > 0)
            {
                var custEvent = CustomEventsToFire.Dequeue();
        ...
        public static void FireCustomEventNextFrame(string customEventName, Transform eventOrigin) {
            ...
            CustomEventsToFire.Enqueue(new CustomEventToFireInfo {
